...
// Changes done for Real-time Auto-completion Widget for terminal
...
// ACwidget changes begin
	...
	if(fd==0)
	{
		mkfifo("/home/user-name/v2f",S_IFIFO|S_IRWXU|S_IRWXG|S_IRWXO);  // Change the 'user-name' to your current ubuntu username 
		fd=open("/home/user-name/v2f",O_WRONLY|O_NONBLOCK);		// Change the 'user-name' to your current ubuntu username 
	}
